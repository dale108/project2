...
public class Main
{
    ...
    private static void makeReservationMenu() throws FileNotFoundException 
    {
        ...
        Guest guest = null;
        ProjectLinkedList<Room> availableRooms = new ProjectLinkedList<Room>();
        Reservation reservation = null;
    ...
    { 
        ...
        ProjectLinkedList<Reservation> guestReservations = new ProjectLinkedList<>();
    ...
    { 
        ...
        switch( selectionInt )
        {
            ...
            break;
            case 2:
            ProjectLinkedList<String> invoicesPaid = hotel.getAllInvoicesPaid();
            System.out.println("\n" + "All paid invoices: ");
            System.out.println(invoicesPaid); 
            break;     
            case 3:
            ProjectLinkedList<String> invoicesUnpaid = hotel.getAllInvoicesUnpaid();
            System.out.println("\n" + "All unpaid invoices: ");
     ...
     */
    private static ProjectLinkedList<Room> roomOptionsTrimmer(int partySize, int priceRange)
    {
        ProjectLinkedList<Room> returnList = new ProjectLinkedList<>();

        ProjectLinkedList<Room> rooms = hotel.getAllRoomsList();
